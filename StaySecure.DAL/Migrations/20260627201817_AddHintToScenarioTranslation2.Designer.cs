...
namespace StaySecure.DAL.Migrations
{
    ...
    [Migration("20260627201817_AddHintToScenarioTranslation2")]
    partial class AddHintToScenarioTranslation2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StaySecure.DAL.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<bool>("ChallengesUnlocked")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("StaySecure.DAL.Models.LoginLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StaySecure.DAL.Models.UserDailyTip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserDailyTips");
                });

            modelBuilder.Entity("StaySecure.DAL.Models.UserScenario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StaySecure.DAL.Models.UserWeakCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StaySecure.DAL.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StaySecure.DAL.Models.UserDailyTip", b =>
                {
                    b.HasOne("StaySecure.DAL.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
